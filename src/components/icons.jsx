...
export function UpworkIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M18.56 8.6c-1.7 0-3.02 1.12-3.55 2.72-.7-1.06-1.28-2.3-1.62-3.35h-2.28v6.06c0 1.2-.98 2.18-2.18 2.18a2.18 2.18 0 0 1-2.17-2.18v-6.06H4.5v6.06a4.36 4.36 0 0 0 8.71.3 8.9 8.9 0 0 0 1.4-2.16c.53 1.43 1.44 2.86 2.6 3.85l-.9 4.16h2.3l.66-3.1c.48.1.98.15 1.5.15a4.53 4.53 0 1 0-.2-9.63zm-.02 6.87c-.63 0-1.24-.16-1.8-.44.5-1.38.72-2.85 1.86-2.85.9 0 1.63.74 1.63 1.64 0 .9-.79 1.65-1.69 1.65z" />
    </svg>
  )
}
